...
const products = [
    { name: 'Grand Bridal Set', category: 'Bridal Sets', note: 'Complete bridal jewelry including necklace, earrings & maang tikka' },
    { name: 'Pearl Chandelier Earrings', category: 'Earrings', note: 'Elegant drop earrings with pearl accents' },
    { name: 'Kundan Bangle Set', category: 'Bangles', note: 'Intricate kundan work bangles — set of 6' },
    { name: 'Layered Gold Necklace', category: 'Necklaces', note: 'Multi-strand layered statement necklace' },
    { name: 'Reception Jewelry Set', category: 'Bridal Sets', note: 'Glamorous set for reception evening wear' },
    { name: 'Floral Drop Earrings', category: 'Earrings', note: 'Delicate flower petal design earrings' },
    { name: 'Celebration Bangle Set', category: 'Bangles', note: 'Gold-tone bangles for festive occasions' },
    { name: 'Choker Necklace', category: 'Necklaces', note: 'Classic fitted choker with stone detailing' },
    { name: 'Engagement Jewelry Set', category: 'Occasion', note: 'Elegant set for engagement ceremonies' },
    { name: 'Hoop Earrings with Stones', category: 'Earrings', note: 'Premium stone-set hoop earrings' },
    { name: 'Temple Jewelry Set', category: 'Bridal Sets', note: 'Traditional temple-design bridal set' },
    { name: 'Anniversary Gift Set', category: 'Occasion', note: 'Curated jewelry set perfect for gifting' },
];
            ...
            <main>
                ...
                <section style={{ padding: '6rem 2rem', background: 'var(--ivory)' }}>
                    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', justifyContent: 'center', marginBottom: '3rem' }}>
                            {categories.map((cat) => (
                                <span key={cat} className="filter-tab" style={{
                                    fontFamily: 'Manrope, sans-serif', fontSize: '0.78rem', fontWeight: 600,
                                    letterSpacing: '0.1em', textTransform: 'uppercase',
                                    padding: '0.5rem 1.25rem', border: '1.5px solid rgba(201,169,110,0.3)',
                                    borderRadius: '2px', cursor: 'pointer', color: 'var(--taupe)',
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '1.5rem' }}>
                            {products.map((product) => (
                                <div key={product.name} className="havaku-card">
                                    <ImagePlaceholder width={220} height={220} label={product.name} style={{ width: '100%', aspectRatio: '1' }} />
                ...
                <section style={{ padding: '4rem 2rem', background: 'var(--soft-black)', textAlign: 'center' }}>
                    <div style={{ maxWidth: '650px', margin: '0 auto' }}>
                        ...
                        <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.3rem', fontStyle: 'italic', color: 'var(--warm-white)', marginBottom: '0.75rem' }}>
